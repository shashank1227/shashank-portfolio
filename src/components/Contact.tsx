...
import { logContactSubmit, logOutboundClick } from '@/utils/analytics';
...
const Contact: React.FC = () => {
  ...
  const trackContactLink = (url: string, label: string) => {
    logOutboundClick(url, label, 'contact');
  };
          ...
          >
            ...
            <ContactDetails>
              <ContactItem
                ...
                onClick={() => trackContactLink('mailto:shashanknet50@gmail.com', 'email')}
              >
              ...
              <ContactItem
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackContactLink('tel:+919129853380', 'phone')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <ContactItem
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackContactLink('https://linkedin.com/in/shashesi', 'linkedin')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <ContactItem
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackContactLink('https://github.com/shashank1227', 'github')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
